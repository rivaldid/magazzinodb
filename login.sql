...
IN IN_REMOTE_ADDR INT UNSIGNED,
...
VALUES(IN_REQUEST_TIME,IN_REQUEST_URI,IN_HTTP_REFERER,INET_ATON(IN_REMOTE_ADDR),IN_REMOTE_USER,IN_PHP_AUTH_USER,IN_HTTP_USER_AGENT);
END //
DELIMITER ;
